...
const CATEGORIES = [
  { cat: 'CPU', queries: ['AMD 라이젠 CPU', '인텔 코어 CPU', '인텔 코어 울트라', '라이젠5', '라이젠7', '라이젠9', '코어i3', '코어i5', '코어i7', '코어i9', '라이젠 7600', '라이젠 7700', '라이젠 9600X', '라이젠 9700X', '라이젠 9800X3D', '라이젠 9950X', '라이젠 8500G', '라이젠 8700G', '코어 울트라5', '코어 울트라7', '코어 울트라9', '인텔 14400F', '인텔 14600K', '인텔 14700K', '인텔 14900K', '라이젠 5500', '라이젠 5600G', '라이젠 8600G', '인텔 12100F', '인텔 13100F', '인텔 코어i3 14100F', '인텔 코어i5 14500', '인텔 코어i7 14700F', '라이젠 7600', '라이젠 9600X', '라이젠 9950X3D', 'AMD 라이젠5 8500G', '라이젠 5700X', '라이젠 7700X', '인텔 코어 울트라9 285K', '인텔 코어 울트라5 245K'], match: ['CPU'], target: 150, parse: parseCpu, requireSocket: true },
  { cat: 'GPU', queries: ['그래픽카드', '지포스 RTX', '라데온 RX', '갤럭시 그래픽카드', '이엠텍 그래픽카드', '조텍 그래픽카드', 'MSI 그래픽카드', '기가바이트 그래픽카드', 'ASUS 그래픽카드', '컬러풀 그래픽카드', 'PNY 그래픽카드', '이엠텍 RTX', 'RTX 5090', 'RTX 5080', 'RTX 5070 Ti', 'RTX 5070', 'RTX 5060 Ti', 'RTX 5060', 'RTX 4060', 'RTX 4060 Ti', 'RTX 4070', 'RTX 4070 Super', 'RTX 4080', 'RX 7600', 'RX 7700 XT', 'RX 7800 XT', 'RX 7900 XT', 'RX 9070', 'RX 9070 XT', '지포스 4060', '지포스 5070', '라데온 7800', 'MSI 지포스', 'ASUS 라데온', '갤럭시 RTX 5070', '이엠텍 RTX 5060', '조텍 RTX 5070 Ti', 'RTX 4070 Ti', 'RTX 4070 Ti Super', 'RTX 5050', 'RX 7600 XT', 'RX 6750 XT', '인텔 아크 그래픽카드', '그래픽카드 8GB', '그래픽카드 16GB', '기가바이트 RTX', '이엠텍 라데온', '컬러풀 RTX', 'ASUS TUF 그래픽카드', 'MSI 게이밍 그래픽카드'], match: ['그래픽카드'], target: 450, parse: parseGpu },
  { cat: 'MOTHERBOARD', queries: ['메인보드', 'ASUS 메인보드', 'MSI 메인보드', '기가바이트 메인보드', 'ASRock 메인보드', '바이오스타 메인보드', 'B650 메인보드', 'B760 메인보드', 'B850 메인보드', 'B860 메인보드', 'X670 메인보드', 'X870 메인보드', 'Z790 메인보드', 'Z890 메인보드', 'B550 메인보드', 'A620 메인보드', 'H610 메인보드', 'ASUS B650', 'MSI B760', '기가바이트 B850', 'ASRock B650', 'TUF 메인보드', 'MSI 박격포', 'MSI 토마호크', 'ASUS 프라임 메인보드', 'ASUS 스트릭스 메인보드', 'B650M 메인보드', 'B760M 메인보드', 'B850M 메인보드', 'B860M 메인보드', 'A620M 메인보드', 'H610M 메인보드', 'MSI 프로 메인보드', '기가바이트 어로스 메인보드', 'ASRock 스틸레전드', 'ASUS B760', 'MSI B650', '화이트 메인보드', 'ITX 메인보드', 'X870E 메인보드', '바이오스타 메인보드', 'ASRock 메인보드', '기가바이트 게이밍 메인보드', 'MSI 엣지 메인보드'], match: ['메인보드'], target: 450, parse: parseMotherboard, requireSocket: true },
  { cat: 'MEMORY', queries: ['DDR5 데스크탑 메모리', 'DDR4 데스크탑 메모리', '삼성 메모리 램', 'SK하이닉스 메모리', '팀그룹 메모리', '커세어 메모리', 'G.SKILL 메모리', '에센코어 메모리', '킹스톤 메모리', '마이크론 메모리', '클레브 메모리', 'GeIL 메모리', '한성 메모리', 'TeamGroup DDR5', 'DDR5 16GB', 'DDR5 32GB', 'DDR4 16GB', 'DDR5 6000', 'DDR5 5600', '삼성 DDR5 16GB', '팀그룹 DDR5', '커세어 DDR5', 'GSKILL DDR5', 'RGB 튜닝 메모리', 'DDR5 6400', 'DDR5 48GB', 'DDR5 64GB', 'DDR4 32GB', '커세어 베놈', '에센코어 클레브 DDR5', '아오리스 메모리', '게일 메모리', 'DDR5 튜닝램'], match: ['RAM', '메모리'], target: 320, parse: parseMemory },
  { cat: 'SSD', queries: ['SSD', 'NVMe SSD', 'M.2 SSD', '삼성 SSD', 'SK하이닉스 SSD', '마이크론 SSD', 'WD SSD', '키오시아 SSD', '솔리다임 SSD', '팀그룹 SSD', '1TB SSD', '2TB SSD', '4TB SSD', '500GB SSD', '삼성 990', '삼성 980', 'WD 블랙 SSD', '시게이트 SSD', 'ADATA SSD', '렉사 SSD', 'PNY SSD', '마이크론 P3', 'SK하이닉스 P31', 'Gen4 SSD', 'Gen5 SSD', '삼성 990 EVO', '삼성 990 PRO 2TB', 'WD SN770', 'WD 블랙 SN850X', '마이크론 크루셜 SSD', 'SK하이닉스 P41', '키오시아 엑세리아', '솔리다임 P44', 'PNY SSD 1TB', 'ADATA 레전드 SSD', '삼성 870 EVO', '마이크론 P3 Plus', 'SK하이닉스 튜브', 'NVMe 2TB Gen4'], match: ['SSD'], target: 420, parse: parseSsd },
  { cat: 'HDD', queries: ['하드디스크 HDD', '시게이트 하드', 'WD 하드', '도시바 하드', '4TB 하드디스크', '8TB 하드디스크', '2TB 하드디스크', '6TB 하드디스크', '10TB 하드디스크', 'WD Blue 하드', '시게이트 바라쿠다', 'WD 레드', '시게이트 아이언울프', 'WD Blue 4TB', '시게이트 바라쿠다 2TB', '도시바 P300', 'WD Red Plus', '시게이트 스카이호크', 'WD 1TB 하드', '시게이트 1TB 하드', '도시바 1TB 하드', 'WD Gold 하드', '시게이트 8TB', 'WD 8TB'], match: ['HDD', '하드'], target: 110, parse: parseHdd },
  { cat: 'PSU', queries: ['파워서플라이', '마이크로닉스 파워', '시소닉 파워', '잘만 파워', 'FSP 파워', '슈퍼플라워 파워', '커세어 파워', '안텍 파워', '쿨러마스터 파워', '800W 파워', '750W 파워', '골드 파워', '600W 파워', '850W 파워', '1000W 파워', '마이크로닉스 클래식', '시소닉 포커스', '에너맥스 파워', 'be quiet 파워', 'ATX 3.1 파워', '풀모듈러 파워', '700W 파워', '500W 파워', '1200W 파워', '시소닉 프라임', '커세어 RM 파워', '마이크로닉스 컴페티션', 'FSP 헥사 파워', '잘만 파워 골드', '브론즈 700W 파워', 'ATX 3.0 파워', '화이트 파워', '쿨러마스터 MWE', '시소닉 비전', '650W 골드 파워', '850W 골드 파워'], match: ['파워'], target: 360, parse: parsePsu },
  { cat: 'CASE', queries: ['컴퓨터 케이스', '앱코 케이스', '다크플래쉬 케이스', '마이크로닉스 케이스', '쿨러마스터 케이스', '리안리 케이스', 'NZXT 케이스', '커세어 케이스', '3RSYS 케이스', '잘만 케이스', '프랙탈 케이스', 'ATX 케이스', '미니타워 케이스', '강화유리 케이스', '화이트 케이스', '빅타워 케이스', 'M-ATX 케이스', 'ITX 케이스', '대양케이스', 'GMC 케이스', 'darkFlash 케이스', '리안리 오뉴', '앱코 수트', 'M-ATX 케이스 화이트', '메쉬 케이스', '3RSYS 케이스', 'darkFlash 케이스', 'NZXT H5', '커세어 4000D', '리안리 라칸', '프랙탈 노스', 'ITX 케이스 화이트', '게이밍 케이스', '미들타워 화이트', '빅타워 케이스', '강화유리 케이스 화이트', '쿨러마스터 케이스', '듀얼챔버 케이스', '파노라마 케이스'], match: ['케이스'], target: 420, parse: parseCase },
  { cat: 'CPU_COOLER', queries: ['CPU 쿨러', '공랭 쿨러', '수랭 쿨러', '쿨러마스터 쿨러', '딥쿨 쿨러', '써멀라이트 쿨러', 'PCCOOLER 쿨러', '잘만 쿨러', '3RSYS 쿨러', '녹투아 쿨러', 'NZXT 수랭', '360 수랭', '240 수랭', '공랭 CPU 쿨러', '딥쿨 AK620', '써멀라이트 PA120', '아크틱 수랭', '잘만 수랭', '써모랩 쿨러', '한성 쿨러', '타워형 쿨러', 'CPU 수랭쿨러', '딥쿨 AK400', '써멀라이트 어쌔신', 'PCCOOLER RZ620', '잘만 CNPS', '아크틱 프리저', '쿨러마스터 하이퍼', '240 수랭 화이트', '360 수랭 화이트', '공랭 쿨러 화이트', '딥쿨 LS720', 'NZXT 크라켄', '써멀라이트 PA120', '딥쿨 AK620 화이트', '빅타워 공랭쿨러'], match: ['쿨러'], target: 380, parse: parseCooler },
]
